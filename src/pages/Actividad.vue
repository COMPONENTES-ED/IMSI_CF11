      ...
      >
        ...
        <div class="col-12 col-md-8 col-lg-9">
          <div class="titulo-segundo">
            <h2>
              Prueba de conocimientos sobre certificación de cableado
              estructurado: pruebas y estándares.
            </h2>
          </div>
          <p class="mb-4">
            Validar el conocimiento adquirido sobre certificación de cableado
            estructurado: pruebas y estándares. Esto se trabaja a partir de un
